...
/***/ function(module, exports, __webpack_require__) {
	...
	var Landing = React.createClass({
	  ...
	  filterRestaurants: function filterRestaurants(change) {
	    var chosenCuisine = this.state.chosenCuisine;
	    var chosenCost = this.state.chosenCost;
	    var self = this;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { id: 'rightSide' },
	          React.createElement(WheelOfFortune, { restaurants: sampleData.lunchChoices })
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var WheelWedge = __webpack_require__(162);
	...
	var WheelOfFortune = React.createClass({
	  ...
	  loadWheel: function loadWheel() {
	    ...
	    var randomNums = this.shuffleNums(tempNumsArray);
	  ...
	  handleSpinClick: function handleSpinClick(event) {
	    ...
	    the indicator */
	    var items = document.getElementsByClassName('sec');
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { id: 'inner-wheel' },
	          wheelWedges.map(function (restaurant) {
	            return React.createElement(WheelWedge, { restaurant: restaurant.name, key: restaurant.id });
	          })
	        ),
	        React.createElement(
	          'div',
	          { id: 'spin', onClick: this.handleSpinClick },
	          React.createElement('div', { id: 'inner-spin' })
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var DropDownTool = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PropTypes2 = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecateObjectProperties = __webpack_require__(170);

	var _deprecateObjectProperties2 = _interopRequireDefault(_deprecateObjectProperties);

	var _InternalPropTypes = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createHashHistory = __webpack_require__(177);
